...
class Test(TestCase):
    ...
    def test_get_format(self):
        ...
        for given_pretty_type, given_type, expect in tests:
            with self.subTest(given_pretty_type=given_pretty_type, given_type=given_type, expect=expect):
                self.assertEqual(utils.get_format(given_pretty_type, given_type, given_type), expect)
